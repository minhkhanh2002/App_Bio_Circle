  ...
  static const Map<String, Map<String, List<String>>> _vi = {
    ...
    'intellectual': {
      ...
      'mid': [
        ...
        'Tư duy ở mức tốt vừa phải — chia việc hợp lý sẽ hiệu quả.',
    ...
    'intuition': {
      ...
      'low': [
        ...
        'Trực giác hơi mờ hôm nay, đừng vội tin cảm tính.',
      ],
    },
    'aesthetic': {
      'high': [
        'Cảm quan nghệ thuật thăng hoa — hợp để sáng tạo hoặc thưởng thức cái đẹp.',
        'Gu thẩm mỹ đang rất tốt, thử làm điều gì đó đẹp đẽ đi.',
      ],
      'mid': [
    ...
    'awareness': {
      ...
      'low': [
        'Hơi mơ hồ về bản thân, bình tâm suy ngẫm và tránh tiêu cực.',
        'Nhận thức chưa sắc, để các quyết định lớn lại sau nhé.',
      ],
    },
    'spiritual': {
      'high': [
        'Năng lượng tinh thần dồi dào, tràn yêu thương và kết nối sâu sắc.',
        'Tâm hồn đang an và đầy — hợp để thiền hoặc ở bên người thương.',
      ],
      'mid': [
  ...
  static const Map<String, Map<String, List<String>>> _en = {
    ...
    'intellectual': {
      ...
      'mid': [
        ...
        'Thinking is decently good — split tasks sensibly for efficiency.',
    ...
    'intuition': {
      ...
      'low': [
        ...
        'Intuition is hazy today — don’t rush on gut alone.',
      ],
    },
    'aesthetic': {
      'high': [
        'Artistic senses are soaring — create or enjoy beauty.',
        'Great taste today; try making something lovely.',
      ],
      'mid': [
    ...
    'awareness': {
      ...
      'low': [
        'A bit unclear about yourself; stay calm and avoid negativity.',
        'Awareness is dull; leave big decisions for later.',
      ],
    },
    'spiritual': {
      'high': [
        'Abundant spiritual energy, full of love and deep connection.',
        'Your soul feels calm and full — great for meditation or loved ones.',
      ],
      'mid': [
